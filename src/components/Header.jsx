  ...
  return (
    <>
      ...
      <div className={`header ${visibility && 'noInteraction'}`}>
        ...
        <Link to={'/Portfolio/contact/'} onClick={() => {setMenuState(false)}}><Button text={"Let's Connect"} isFilled={false} /></Link>
        ...
        >
          <svg
            className={`menuIconsvg ${menuState ? "menuOpen" : "menuHover"}`}
            width="42"
            height="42"
            viewBox="0 0 44 44"
            fill="none"
          ...
          >
            ...
            <rect
              ...
              height="43"
              rx="4.5"
              transform="rotate(-90 0.5 26.5)"
              stroke="white"
            />
          </svg>

          <div className={`menuIcon ${menuState && "menuIconHide"}`}>
            <div className="menuIconCircle"></div>
            <div className="menuIconCircle topCenter"></div>
            <div className="menuIconCircle"></div>

            <div className="menuIconCircle centerLineCircleLeft"></div>
            <div className="menuIconCircle center"></div>
            <div className="menuIconCircle centerLineCircleRight"></div>

            <div className="menuIconCircle"></div>
            <div className="menuIconCircle bottomCenter"></div>
            <div className="menuIconCircle"></div>
          </div>
        </div>
      </div>
